...
// Current page - Bars & Cafes (index 3)
const CURRENT_PAGE_INDEX = 3;

export default function BarsCafePage() {
    ...
    <main className="w-full bg-white text-black">
      <section className="relative isolate h-[60vh] md:h-[90vh] overflow-hidden">
        <motion.div initial={{ scale: 1.08 }} animate={{ scale: 1 }} transition={{ duration: 1.2, ease: "easeOut" }} className="absolute inset-0">
          <Image src="/bars.jpg" alt="Bars & Cafes Solutions" fill priority className="object-cover object-center" />
        </motion.div>
        ...
        <div className="relative z-10 mx-auto flex h-full max-w-7xl flex-col justify-center px-6 sm:px-8">
          <motion.div initial="hidden" animate="visible" variants={heroList} className="text-center">
            <motion.h1 variants={heroShow} className="text-white text-4xl sm:text-5xl md:text-6xl md:mt-24 font-bold tracking-tight leading-tight">Bars & Cafes Solutions</motion.h1>
