...
export default function HardSurfaceCleaningPage() {
  return (
    <main className="w-full bg-white text-black">
      ...
      <section className="relative isolate h-[60vh] md:h-[90vh] overflow-hidden">
        ...
        >
          <Image
            src="/hardsurface_hero.jpg"
            alt="Hard Surface Cleaning Products"
            fill
            priority
        ...
        <div className="relative z-10 mx-auto flex h-full max-w-7xl flex-col justify-center px-6 sm:px-8">
          ...
          >
            ...
            >
              SOLUTIONS FOR GENERAL SURFACES AND SPECIALTY CLEANING NEEDS
            </motion.p>
          </motion.div>
        </div> 
      </section>

      {/* Hard Surface Cleaning Section */}
