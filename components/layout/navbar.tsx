        ...
        {isMenuOpen && (
          <div className="absolute top-full left-0 mt-2 w-full px-4 md:hidden">
            <div className="rounded-2xl bg-white/95 backdrop-blur shadow-xl p-6 flex flex-col space-y-4 text-center border border-gray-200">
              {/* Mobile links use a simpler style but keep the hover color */}
              <Link href="/" className="text-sm font-bold uppercase tracking-widest text-black hover:text-[#F6AB27] transition-colors">Home</Link>
              <Link href="/solution" className="text-sm font-bold uppercase tracking-widest text-black hover:text-[#F6AB27] transition-colors">Solution</Link>
              <Link href="/products" className="text-sm font-bold uppercase tracking-widest text-black hover:text-[#F6AB27] transition-colors">Products</Link>
