            ...
            <div>
              ...
              >
                ...
                <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 ${isIngredientsOpen ? 'bg-[#0061d4]' : 'bg-[#e2e2e2] group-hover:bg-[#0061d4]'}`}>
                  <ChevronDown 
                    size={20} 
                    className={`transition-all duration-300 ${isIngredientsOpen ? 'text-white rotate-180' : 'text-gray-600 group-hover:text-white'}`} 
                  />
                </div>
              </button>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div>
                ...
                >
                  ...
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 ${isUsageOpen ? 'bg-[#0061d4]' : 'bg-gray-400/50 group-hover:bg-[#0061d4]'}`}>
                    <ChevronDown 
                      size={16} 
                      className={`text-white transition-transform duration-300 ${isUsageOpen ? 'rotate-180' : ''}`} 
                    />
                  </div>
                </button>
              ...
              <div>
                ...
                <button
                  ...
                  className={`w-full flex items-center justify-between px-6 py-4 rounded-lg shadow-sm group transition-colors ${
                    isWarningsOpen 
                      ? 'bg-red-100' 
                      : 'bg-[#e2e2e2] hover:bg-red-50'
                  }`}
                >
                  <span className={`text-base md:text-2xl font-medium transition-colors ${
                    isWarningsOpen ? 'text-red-600' : 'text-[#1a1a1a] group-hover:text-red-600'
                  }`}>
                    Warnings
                  </span>
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 ${
                    isWarningsOpen 
                      ? 'bg-red-500' 
                      : 'bg-gray-400/50 group-hover:bg-red-500'
                  }`}>
                    <ChevronDown 
                      size={16} 
                      className={`text-white transition-transform duration-300 ${isWarningsOpen ? 'rotate-180' : ''}`} 
                    />
                  </div>
                </button>
